...
* [Main Mobile](1. Main Mobile@2x.png) - Основной вид календаря.
* [Delete Mobile](2. Delete Mobile@2x.png) - После выбора события, появляется кнопка Delete.
* [Add Mobile](3. Add Mobile@2x.png) - После нажатия `+` появляется стандартный попап (функция `prompt`) добавления события.
